...
const ShowNFT = () => {
  ...
  return (
    ...
    >
      <div className="bg-[#151c25] shadow-md shadow-cyan-100 rounded-xl w-11/12 md:w-2/5 h-7/12 p-6">
        <div className="flex flex-col">
          <div className="flex flex-row justify-between items-center">
            <p className="font-semibold text-2xl text-gradient">Buy NFT</p>
            <button
              type="button"
            ...
            <div className="flex justify-between items-center mt-3 text-white">
              <div className="flex justify-start items-center">
                ...
                <div className="flex flex-col justify-center items-start">
                  ...
                  <small className="text-cyan-800 font-semibold">
          ...
          <div className="flex justify-between items-center space-x-2">
            {connectedAccount == nft?.owner ? (
              <button
                ...
                w-full text-cyan-500 text-md border-cyan-200
                py-2 px-5 rounded-full bg-transparent 
                drop-shadow-xl border hover:bg-cyan-500
