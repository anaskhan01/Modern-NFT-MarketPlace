...
const UpdateNFT = () => {
  ...
  return (
    ...
    >
      <div className="bg-[#151c25] shadow-xl shadow-[black] rounded-xl w-11/12 md:w-2/5 h-7/12 p-6">
        <form className="flex flex-col">
          ...
          <button
            ...
            w-full text-white text-md bg-cyan-500
            hover:bg-cyan-200 py-2 px-5 rounded-full
            drop-shadow-xl border border-transparent
            hover:bg-transparent hover:text-cyan-500
            hover:border hover:border-cyan-200
